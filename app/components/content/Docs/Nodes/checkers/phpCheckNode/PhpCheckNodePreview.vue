<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="php-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-phpCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      PHP version checker node for detecting and verifying PHP installation.
    </p>
  </div>
</template>
...
const PhpCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/PhpCheckNode.vue"));
