<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="browser-node-preview-wrapper" style="width: 100%; max-width: 700px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-browserNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Browser preview node with full browser capabilities, viewport connections, and automation pipeline support.
    </p>
  </div>
</template>
...
const BrowserNode = defineAsyncComponent(() => import("~/components/canvas/nodes/BrowserNode.vue"));
