...
Commands:
  init [options]                     Initialize buildit in your Nuxt project.
...
This command will initialize buildit in your Nuxt project. This will:
...
Initialize buildit in your Nuxt project.
