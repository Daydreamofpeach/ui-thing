<template>
	<div v-if="isOpen" class="git-actions-modal-overlay" @click="handleOverlayClick">
		<div class="git-actions-modal" @click.stop>
			<!-- Modal Header -->
			<div class="modal-header">
				<div class="modal-title">
					<Icon name="lucide:git-branch" class="title-icon" />
					<h2>Select Git Command</h2>
				</div>
...
<script setup lang="ts">
	...
	import GitActions from "../selectors/GitActions.vue";
	...
	watch(() => props.currentCommand, (newCommand) => {
		selectedCommand.value = newCommand || null;
	});
