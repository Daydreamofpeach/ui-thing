<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="event-node-preview-wrapper" style="width: 100%; max-width: 400px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-eventNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Event trigger node that listens for and fires workflow events. Used to create event-driven workflows.
    </p>
  </div>
</template>
...
const EventNode = defineAsyncComponent(() => import("~/components/canvas/nodes/childNodes/EventNode.vue"));
