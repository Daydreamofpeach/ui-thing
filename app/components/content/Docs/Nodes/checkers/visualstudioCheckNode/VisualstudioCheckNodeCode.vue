...
onMounted(() => {
  const minimalDoc = "Visual Studio checker node using AppStatusCard component and useAppDetection composable for reliable detection and installation support.";
...
@keyframes visualstudioPulse {
  ...
  const files: FileStructure[] = [
    {
      title: "VisualStudioCheckNode.vue",
      icon: "vscode-icons:file-type-vue",
      path: "components/canvas/nodes/VisualStudioCheckNode.vue",
      content: mainCode
    },
    {
