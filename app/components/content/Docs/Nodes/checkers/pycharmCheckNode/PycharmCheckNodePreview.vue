  ...
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="node-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        ...
        >
          <template #node-pycharmCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      PyCharm checker node for detecting and verifying PyCharm installation.
    </p>
  </div>
</template>
...
const PycharmCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/PycharmCheckNode.vue"));

const nodeTypes = {
  pycharmCheckNode: PycharmCheckNode
};

const demoNode = ref({
  id: "demo-pycharm-check-node",
  type: "pycharmCheckNode",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
    label: "PyCharm Check"
