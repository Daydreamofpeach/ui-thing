  ...
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="node-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        ...
        >
          <template #node-webstormCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      WebStorm checker node for detecting and verifying WebStorm installation.
    </p>
  </div>
</template>
...
const WebstormCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/WebstormCheckNode.vue"));

const nodeTypes = {
  webstormCheckNode: WebstormCheckNode
};

const demoNode = ref({
  id: "demo-webstorm-check-node",
  type: "webstormCheckNode",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
    label: "WebStorm Check"
  }
});
</script>
