<template>
	<div v-if="isOpen" class="views-modal-overlay" @click="handleOverlayClick">
		<div class="views-modal" @click.stop>
			<!-- Modal Header -->
			<div class="modal-header">
				<div class="modal-title">
					<Icon name="lucide:layout-grid" class="title-icon" />
					<h2>Select View Type</h2>
				</div>
...
<script setup lang="ts">
	...
	import Views from "../selectors/Views.vue";
	...
	const selectedView = ref<string | null>(props.currentView || null);
	...
	function handleViewSelect(viewName: string) {
		selectedView.value = viewName;
	}

	function confirmSelection() {
		if (selectedView.value) {
			emit("select", selectedView.value);
			closeModal();
		}
	}
