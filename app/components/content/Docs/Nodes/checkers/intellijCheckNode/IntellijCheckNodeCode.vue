...
onMounted(() => {
  const minimalDoc = "IntelliJ IDEA checker node using AppStatusCard component and useAppDetection composable for reliable detection and installation support.";
...
@keyframes intellijPulse {
  ...
  const files: FileStructure[] = [
    {
      title: "IntellijCheckNode.vue",
      icon: "vscode-icons:file-type-vue",
      path: "components/canvas/nodes/IntellijCheckNode.vue",
      content: mainCode
    },
    {
