...
onMounted(() => {
  const minimalDoc = "Rust version checker node using BaseNodeTemplate, LanguageStatusCard component and useLanguageDetection composable.";
          ...
          children: [
            {
              ...
              children: [
                {
                  title: "RustCheckNode.vue",
                  icon: "vscode-icons:file-type-vue",
                  path: "components/canvas/nodes/RustCheckNode.vue",
                  content: "// Uses LanguageStatusCard and useLanguageDetection composable"
                },
                {
                  title: "shared",
                  openIcon: "vscode-icons:default-folder-opened",
                  ...
                  children: [
                    {
                      ...
                      content: "// Language status card component"
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      ...
                      content: "// Language detection composable with Tauri support"
                    }
                  ]
                }
              ]
