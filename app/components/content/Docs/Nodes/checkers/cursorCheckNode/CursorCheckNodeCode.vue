...
onMounted(() => {
  const minimalDoc = "Cursor checker node using AppStatusCard component and useAppDetection composable for reliable detection and installation support.";
...
@keyframes cursorPulse {
  ...
  const files: FileStructure[] = [
    {
      title: "CursorCheckNode.vue",
      icon: "vscode-icons:file-type-vue",
      path: "components/canvas/nodes/CursorCheckNode.vue",
      content: mainCode
    },
    {
