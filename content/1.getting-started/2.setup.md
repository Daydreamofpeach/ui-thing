---
title: Setup
description: Learn how to setup your Nuxt project with buildit.
---

So you want to use buildit in your Nuxt project? Great! This guide will walk you through the steps to get started.

## Prerequisites

Before you can use buildit, you need to have a Nuxt project. If you don't have one yet, you can create one with the following command:
...
Once you have a Nuxt project, you can initialize buildit with the following command:
...
buildit ships with several pre-made themes.
...
This will ask you to select the theme you want to add to your project. Once you have selected a theme, buildit will ask you if you want to overwrite your `tailwind.css` file. If you answer yes, it will overwrite your `tailwind.css` file with the theme you selected.
