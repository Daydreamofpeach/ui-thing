<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="buildit-cli-preview-wrapper" style="width: 100%; max-width: 500px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-builditCli="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      BuildIt CLI checker node for verifying BuildIt CLI installation and version.
    </p>
  </div>
</template>
...
const BuilditCliNode = defineAsyncComponent(() => import("~/components/canvas/nodes/BuilditCLINode.vue"));

const nodeTypes = {
  builditCli: BuilditCliNode
};

const demoNode = ref({
  id: "demo-buildit-cli-node",
  type: "builditCli",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
