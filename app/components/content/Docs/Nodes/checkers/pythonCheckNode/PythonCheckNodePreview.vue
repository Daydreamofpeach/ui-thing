<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="python-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-pythonCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Python version checker node with support for python, python3, and py (Python Launcher) commands. Includes automatic detection and installation support.
    </p>
  </div>
</template>
...
const PythonCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/PythonCheckNode.vue"));
...
const demoNode = ref({
  id: "demo-python-check-node",
  type: "pythonCheckNode",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
