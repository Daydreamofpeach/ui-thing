	...
	<UiDialog :open="open" @update:open="onOpenChange">
		<UiDialogContent class="sm:max-w-lg">
			<UiDialogHeader>
				...
				<UiDialogDescription>Provide details to create a new project.</UiDialogDescription>
			</UiDialogHeader>
			<form class="space-y-4" @submit.prevent="submit">
				<div class="space-y-2">
					<UiLabel for="proj-name">Name</UiLabel>
					<UiInput id="proj-name" v-model="name" placeholder="New project" required />
				</div>
				<div class="space-y-2">
					<UiLabel for="proj-desc">Description</UiLabel>
					<UiInput id="proj-desc" v-model="description" placeholder="Optional description" />
				</div>
