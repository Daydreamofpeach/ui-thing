  ...
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="node-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        ...
        >
          <template #node-notepadppCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Notepad++ checker node for detecting and verifying Notepad++ installation.
    </p>
  </div>
</template>
...
const NotepadppCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/NotepadppCheckNode.vue"));

const nodeTypes = {
  notepadppCheckNode: NotepadppCheckNode
};

const demoNode = ref({
  id: "demo-notepadpp-check-node",
  type: "notepadppCheckNode",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
    label: "Notepad++ Check"
