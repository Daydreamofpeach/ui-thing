<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="rust-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-rustCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Rust version checker node using LanguageStatusCard component for detection.
    </p>
  </div>
</template>
...
const RustCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/RustCheckNode.vue"));
