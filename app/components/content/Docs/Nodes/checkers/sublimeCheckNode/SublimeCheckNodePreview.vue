  ...
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="node-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        ...
        >
          <template #node-sublimeCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Sublime Text checker node for detecting and verifying Sublime Text installation.
    </p>
  </div>
</template>
...
const SublimeCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/SublimeCheckNode.vue"));

const nodeTypes = {
  sublimeCheckNode: SublimeCheckNode
};

const demoNode = ref({
  id: "demo-sublime-check-node",
  type: "sublimeCheckNode",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
    label: "Sublime Check"
