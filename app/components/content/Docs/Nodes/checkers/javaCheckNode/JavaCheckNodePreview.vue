<template>
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="java-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        <VueFlow
          :nodes="[demoNode]"
          :edges="[]"
        ...
        >
          <template #node-javaCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Java version checker node for detecting and verifying Java JDK installation.
    </p>
  </div>
</template>
...
const JavaCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/JavaCheckNode.vue"));
