...
onMounted(() => {
  const minimalDoc = "VS Code checker node using AppStatusCard component and useAppDetection composable for reliable detection and installation support.";
...
@keyframes vscodePulse {
  ...
  const files: FileStructure[] = [
    {
      title: "VscodeCheckNode.vue",
      icon: "vscode-icons:file-type-vue",
      path: "components/canvas/nodes/VscodeCheckNode.vue",
      content: mainCode
    },
    {
