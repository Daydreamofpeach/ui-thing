...
onMounted(() => {
  const minimalDoc = "Git checker node using AppStatusCard component and useAppDetection composable for reliable detection and installation support.";
...
@keyframes gitPulse {
  ...
  const files: FileStructure[] = [
    {
      title: "GitCheckNode.vue",
      icon: "vscode-icons:file-type-vue",
      path: "components/canvas/nodes/GitCheckNode.vue",
      content: mainCode
    },
    {
