  ...
  <div class="flex flex-col items-center justify-center gap-4 w-full">
    <div class="relative flex items-center justify-center p-4 w-full overflow-auto">
      <div class="node-check-preview-wrapper" style="width: 100%; max-width: 450px; margin: 0 auto;">
        ...
        >
          <template #node-visualstudioCheckNode="{ data: node }">
    ...
    <p class="text-sm text-muted-foreground text-center max-w-md">
      Visual Studio checker node for detecting and verifying Visual Studio installation.
    </p>
  </div>
</template>
...
const VisualStudioCheckNode = defineAsyncComponent(() => import("~/components/canvas/nodes/VisualStudioCheckNode.vue"));

const nodeTypes = {
  visualstudioCheckNode: VisualStudioCheckNode
};

const demoNode = ref({
  id: "demo-visualstudio-check-node",
  type: "visualstudioCheckNode",
  position: { x: 0, y: 0 },
  selected: true,
  data: {
    label: "Visual Studio Check"
  }
});
</script>
